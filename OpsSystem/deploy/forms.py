...
class SvnInfoForm(forms.Form):
    ...
    repoAddress = forms.CharField(error_messages={'required': u'请输入库地址'},
                                  ...
                                  widget=forms.TextInput(
                                      attrs={'class': 'form-control', 'placeholder': 'svn://192.168.16.1/repo/trunk'}))
    ...
    onlineDeployIP = forms.CharField(error_messages={'required': u'请输入生产环境IP组'},
                                     ...
                                     required=True,
                                     widget=forms.TextInput(
                                         attrs={'class': 'form-control', 'placeholder': '多个IP以空格相隔'}))
...
class GitInfoForm(forms.Form):
    ...
    repoAddress = forms.CharField(error_messages={'required': u'请输入库地址'}, label=u'Git库地址',
                                  ...
                                  required=True,
                                  widget=forms.TextInput(
                                      attrs={'class': 'form-control', 'placeholder': 'git@192.168.1.1:reponame'}))
...
class RollBackForm(forms.Form):
    ...
    currentVersion = forms.CharField(label=u'当前版本号', error_messages={'required': '请输入当前版本号'}, max_length=50,
                                     required=True,
                                     widget=forms.TextInput(
                                         attrs={'class': 'form-control', 'style': 'width:600px', 'readonly': True}))
