...
class StarkModelForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        for name, field in self.fields.items():
            ...
            field.widget.attrs['lay-filter'] = 'f_'+ name
...
class StarkHandler(object):
    ...
    def changelist_view(self, request, *args, **kwargs):
        ...
        ########### 8.新增一个自定义按钮 #########
        custom_btn = self.get_custom_btn()
    ...
    def check_change(self, request, *args, **kwargs):
        pass
    ...
    @property
    def get_check_change(self):
        """
        获取检测change页面URL的name
        :return:
        """
        return self.get_url_name('check_change')
    ...
    def get_urls(self):
        patterns = [
            ...
            #url(r'^check_change/$', self.wrapper(self.check_change), name=self.get_check_change),
